...
namespace Ascendant.SystemsExtensions.Celestial
{
    public class StarSystem : MonoBehaviour
    {
        ...
        public void InitializeSystem(string systemName)
        {
            ...
            planetObj.transform.localPosition = new Vector3(4500f, 0f, 0f);
            ...
            planetObj.AddComponent<OrbitPath>().InitializePath(4500f);
            m_Bodies.Add(planet);

            // 3. Moon orbiting Terrestrial Planet (placed outside planet's 250f radius)
            var moonObj = new GameObject($"{systemName}_Moon");
            moonObj.transform.SetParent(planetObj.transform);
            moonObj.transform.localPosition = new Vector3(600f, 0f, 0f);
            ...
            gasPlanetObj.AddComponent<OrbitPath>().InitializePath(7500f);
            ...
            beltBody.Radius = 12000f;
            beltBody.ParentBody = m_Star;
            beltObj.AddComponent<OrbitPath>().InitializePath(12000f);
            m_Bodies.Add(beltBody);

            var belt = beltObj.AddComponent<AsteroidBelt>();
            belt.MaxAsteroids = 8;
            belt.InnerRadius = 10500f;
            belt.OuterRadius = 13500f;
            belt.SpawnAsteroids();
        }
    }
}
