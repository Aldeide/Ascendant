// Transporter effect custom shader
...
Shader "Shield"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/Geometry Shaders/Common/CustomVertex.hlsl"
            #include "ShieldGeometry.hlsl"
            #include "ShieldFragment.hlsl"

            // Custom: Shader entry points
            #pragma vertex VertexThru
            #pragma geometry ShieldGeometry
